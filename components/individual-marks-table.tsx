...
export function IndividualMarksTable({ students, existingScores, max }: Props) {
  ...
  return (
    <Table>
      <TableHeader>
        <TableRow>
          <TableHead className="text-zinc-50">Student</TableHead>
          <TableHead className="text-zinc-50">Roll no.</TableHead>
          <TableHead className="text-zinc-50">
          ...
          <TableHead className="text-zinc-50">Total ({max.total})</TableHead>
        </TableRow>
      </TableHeader>
      <TableBody>
        {students.map((student) => {
          ...
          return (
            <TableRow key={student.id}>
              ...
              <TableCell className="text-xs text-zinc-50">
                {total !== null ? total : ""}
              </TableCell>
            </TableRow>
          );
